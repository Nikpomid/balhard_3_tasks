...
def split_to_parts(str_to_split: str) -> tuple:
    ...
    """
    part_1 = str(str_to_split[:len(str_to_split)//2 if len(str_to_split) % 2 == 0
                                else len(str_to_split)//2 + 1])
    part_2 = str(str_to_split[len(str_to_split)//2 if len(str_to_split) % 2 == 0
                                else len(str_to_split)//2 + 1:])
